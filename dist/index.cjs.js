...
var snpkgSnapiNdm = require('@social-native/snpkg-snapi-ndm');
...
const getTxInsertId = async (knex, tx) => {
    const sqlTranslator = snpkgSnapiNdm.getSqlDialectTranslator(knex);
    const { id } = await tx
...
exports.versionRecorderDecorator = version_recorder;
