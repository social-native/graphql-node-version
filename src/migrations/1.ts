...
export type MIGRATION_FILE_EXTENSION = 'js' | 'ts';
export default (config?: ITableAndColumnNames, extension: MIGRATION_FILE_EXTENSION = 'js') => {
    const {
        table_names,
        event,
    ...
    const name = 'initial_files';
    const migration = `
${extension === 'ts' ? "import * as Knex from 'knex'" : ''}
/**********************************************
 * 
 * Generated from graphql node version library
 * 
